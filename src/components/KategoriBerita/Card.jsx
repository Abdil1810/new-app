// src/components/KategoriBerita/CardBerita.jsx
import { format } from "date-fns";

const CardBerita = ({ berita }) => {
  const { judul, isi, tanggal, kategori, gambar } = berita;
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition duration-300">
      ...
      <div className="p-4">
        <p className="text-sm text-gray-500 mb-1">{formatTanggal(tanggal)} • {kategori}</p>
